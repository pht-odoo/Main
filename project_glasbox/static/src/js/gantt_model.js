...
var ProjectGanttModel = GanttModel.extend({
    ...
    _getFields: function () {
        ...
        if (this.modelName == 'project.task'){
            fields.push('completion_date','user_id','task_delay','check_c_date','date_end','milestone','on_hold', 'l_end_date', 'planned_duration', 'buffer_time', 'check_delay', 'check_ahead_schedule', 'check_milestone', 'check_hold', 'check_overdue')
        }
        return fields
    },
